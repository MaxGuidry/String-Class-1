...
int main()
{
	...
	Room Room6  = Room(1, 0, 1, 1, 1,"treasure", "You enter a room with doors to the east, north and south.\nWhat will you do?");
	...
	Room Room10 = Room(0, 1, 0, 0, 0, "key","You enter the room with only a door to the west where you came from.\nYou notice a key on the ground in front of you.\nWhat will you do?");
	...
	Room Room22 = Room(0, 0, 1, 0, 0, "Boss key","You enter the room and see a large key on the ground.\nThere is only a door to the north.\nWhat will you do?");
	...
	while (isGameWon == false)
	{
		...
		else if ((Response.findSubString("grab") == true || Response.findSubString("pickup") == true)&&Response.findSubString(Rooms[PlayerOne.m_positionY][PlayerOne.m_positionX].m_Item)==true)
		{
			PlayerOne.
		}
	}
