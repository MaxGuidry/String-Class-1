...
int main()
{
	...
	Room Room5 = Room(0, 1, 0, 0, 0, "the room you are inhas only the door behind you and a dark hole in the ground,\nLooking down the hole you see nothing, but you can smell the fresh air.\nWhat will you do?", 0, 0, 0, 0, 0, 1);
	...
	while (isGameWon == false)
	{
		...
		if (PlayerOne.m_positionY == 1 && PlayerOne.m_positionX == 3)
		{
			Room9.printPepe();
		}
		if (PlayerOne.m_positionY == 2 && PlayerOne.m_positionX == 1)
		{
			Room9.printDoge();
		}
		if (PlayerOne.m_positionY == 2 && PlayerOne.m_positionX == 4)
		{
			Room15.printHarambe();
		}
